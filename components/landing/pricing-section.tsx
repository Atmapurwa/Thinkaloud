        ...
        <div className="w-full flex flex-col justify-center items-center gap-2">
            ...
            <div className="self-stretch px-6 md:px-16 py-9 relative flex justify-center items-center gap-4">
                ...
                <div className="p-3 relative bg-[rgba(55,50,47,0.03)] border border-[rgba(55,50,47,0.02)] backdrop-blur-[44px] backdrop-saturate-150 backdrop-brightness-110 flex justify-center items-center rounded-lg z-20 before:absolute before:inset-0 before:bg-white before:opacity-60 before:rounded-lg before:-z-10">
                    <div className="p-0.5 bg-[rgba(55,50,47,0.10)] shadow-[0px_1px_0px_white] rounded-[99px] border-[0.5px] border-[rgba(55,50,47,0.08)] flex justify-center items-center gap-[2px] relative">
                        <div
                            className={`absolute top-0.5 w-[calc(50%-1px)] h-[calc(100%-4px)] bg-white shadow-[0px_2px_4px_rgba(0,0,0,0.08)] rounded-[99px] transition-all duration-300 ease-in-out ${billingPeriod === "annually" ? "left-[2px]" : "right-[2px]"
                                }`}
                        />
            ...
            <div className="self-stretch border-b border-t border-[rgba(55,50,47,0.12)] flex justify-center items-center">
                <div className="flex justify-center items-start w-full">
                    ...
                    <div className="flex-1 flex flex-col md:flex-row justify-center items-center gap-6 py-12 md:py-0">
                        ...
                        <div className="flex-1 max-w-full md:max-w-none self-stretch px-6 py-5 border border-[rgba(50,45,43,0.12)] border-[#E0DEDB] overflow-hidden flex flex-col justify-start items-start gap-12 bg-[rgba(255,255,255,0)]">
                            ...
                            <div className="self-stretch flex flex-col justify-start items-center gap-9">
                                ...
                                <Button asChild className="w-full">
                                    <Link href="/app/assignments">Start for Free</Link>
                                </Button>
                            </div>

                            <div className="self-stretch flex flex-col justify-start items-start gap-2">
                                {[
                                    "Access to core AI reading tools (read & listen mode)",
                                    "Limited access to interactive comprehension questions",
                                    "Basic dyslexia-friendly interface",
                                    "Basic analytics",
                                ].map((feature, index) => (
                        ...
                        <div className="flex-1 max-w-full md:max-w-none self-stretch px-6 py-5 bg-primary border border-[rgba(50,45,43,0.12)] border-[rgba(55,50,47,0.12)] overflow-hidden flex flex-col justify-start items-start gap-12">
                            {/* Plan Header */}
                            <div className="self-stretch flex flex-col justify-start items-center gap-9">
                                <div className="self-stretch flex flex-col justify-start items-start gap-2">
                                    ...
                                    <div className="w-full max-w-[242px] text-[#B2AEA9] text-sm font-normal leading-5 font-sans">
                                        Ideal for tutors, educators, or advanced learners who want personalized learning.
                                    </div>
                                </div>
                                ...
                                <Button asChild className="w-full" variant={"secondary"}>
                                    <Link href="/app/assignments">Get Started</Link>
                                </Button>
                            </div>
                            ...
                            <div className="self-stretch flex flex-col justify-start items-start gap-2">
                                {[
                                    ...
                                    "More limit AI reading and listening sessions",
                                    "Real-time voice conversation for comprehension practice",
                                    "Custom voice and speed settings",
                                ].map((feature, index) => (
                                    <div key={index} className="self-stretch flex justify-start items-center gap-[13px]">
                                        <div className="w-4 h-4 relative flex items-center justify-center">
                                            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="flex-1 max-w-full md:max-w-none self-stretch px-6 py-5 bg-white border border-[#E0DEDB] overflow-hidden flex flex-col justify-start items-start gap-12">
                            ...
                            <div className="self-stretch flex flex-col justify-start items-center gap-9">
                                <div className="self-stretch flex flex-col justify-start items-start gap-2">
                                    ...
                                    <div className="w-full max-w-[242px] text-[rgba(41,37,35,0.70)] text-sm font-normal leading-5 font-sans">
                                        Complete solution for large organization, corporate CSR, and government education initiatives.
                                    </div>
                                </div>
                                ...
                                <Button asChild className="w-full">
                                    <Link href="/app/assignments">Contact Sales</Link>
                                </Button>
                            </div>
                            ...
                            <div className="self-stretch flex flex-col justify-start items-start gap-2">
                                {[
                                    ...
                                    "Co-branding options for institutions",
                                    "Custom AI model tuning for school needs",
                                ].map((feature, index) => (
                                    <div key={index} className="self-stretch flex justify-start items-center gap-[13px]">
                                        <div className="w-4 h-4 relative flex items-center justify-center">
                                            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
